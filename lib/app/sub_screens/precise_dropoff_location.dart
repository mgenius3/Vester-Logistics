...
class PreciseDropOffScreen extends StatefulWidget {
  const PreciseDropOffScreen({super.key});

  @override
  State<PreciseDropOffScreen> createState() => _PreciseDropOffScreenState();
}

class _PreciseDropOffScreenState extends State<PreciseDropOffScreen> {
  ...
  @override
  void initState() {
    Fluttertoast.showToast(msg: "Move the map to set drop off location");
  }
        ...
        Positioned(
          ...
          child: Padding(
            ...
            child: ElevatedButton(
              ...
              child: Text("Set Drop Off Current Location"),
            ),
          ),
        )
      ],
